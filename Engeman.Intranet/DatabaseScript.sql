...
CREATE TABLE USERACCOUNT ( 
  ...
  EMAIL                         VARCHAR(50)                         NOT NULL,
	...
	PERMISSIONS                   NVARCHAR(2000)	                    DEFAULT '{"PostType":{"Informative":{"CanPost":1,"CanComment":1,"EditAnyPost":0,"DeleteAnyPost":0,"RequiresModeration":0},"Question":{"CanPost":1,"CanComment":1,"EditAnyPost":0,"DeleteAnyPost":0,"RequiresModeration":0},"Manual":{"CanPost":1,"CanComment":1,"EditAnyPost":0,"DeleteAnyPost":0,"RequiresModeration":0},"Document":{"CanPost":1,"CanComment":1,"EditAnyPost":0,"DeleteAnyPost":0,"RequiresModeration":0}}}'	NOT NULL,
	CHANGE_DATE                   DATETIME DEFAULT CURRENT_TIMESTAMP  NULL,
...
CREATE TABLE COMMENT ( 
  ...
  ACTIVE                        BIT DEFAULT 1                       NOT NULL,
	...
	CONSTRAINT FK_COMMENT_USERACCOUNT FOREIGN KEY (USER_ACCOUNT_ID) REFERENCES USERACCOUNT(ID) ON DELETE CASCADE,
	)ON [PRIMARY]
